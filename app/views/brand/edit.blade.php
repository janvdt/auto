...
@section('instanceContent')
 ...
 <div class="col-md-12">
     <h4>Bewerk de Brand {{$brand->name}}</h4>
 </div>
{{ Form::open(array('action' => array('BrandController@update', $brand->id), 'class' => 'form-horizontal', 'role' => 'form', 'id' => 'Myform')) }}
	<input type="hidden" name="_method" value="PUT">
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Naam</label>
    <div class="col-lg-10">
      <input type="text" class="form-control" id="inputname" name="name" placeholder="Naam Vestiging" value="{{$brand->name}}">
    </div>
  </div>
  <div class="form-group">
    ...
    <textarea id="MyTextArea" name="body" style="display:none;"></textarea>
  	...
  	<div class="form-group">
    	...
    	@if ($brand->image)
			<p><img class="avatar img-polaroid" src="/{{ $brand->image->getSize('medium')->getPathname() }}" alt=""></p>
